          ...
          <div className="bg-white w-7/12 h-1/2 shadow-xl shadow-[#bfb4a3] px-5 py-3 rounded-2xl transition-transform duration-200 ease-in-out transform hover:scale-105 hover:shadow-[#d5c7b2]">
            <a href="#" className="flex flex-col items-start">
              ...
              <h4 className="flex my-1 justify-between items-center gap-9">
                ...
                <GradientBorder className="rounded-full p-0.5 gradient-animate transition-transform duration-300 ease-in-out transform hover:scale-105">
                    <div className="flex px-4 py-1.5 rounded-full bg-white text-md text-black w-10% justify-between transition-transform duration-300 ease-in-out transform hover:bg-gradient-to-r from-[#E07A5F] via-[#81B29A] to-[#9fa5db] gradient-animate hover:border-black">
                        Enroll {date}
                    </div>
                </GradientBorder>
              </h4>

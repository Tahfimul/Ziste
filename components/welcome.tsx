...
const App = () => {
    ...
    return (
        <header className=" bg-white h-screen w-screen relative z-0">
            ...
            <div
                className="absolute -right-[0vw] -top-[0.1vh] overflow-hidden"
            ...
            >
                ...
                >
                    <path
                        d="M294.998 170C252.366 133.484 170.5 184.547 106.999 163.5C19.5 134.5 -14.4862 33.7469 6.49704 0.691351H548.997V508.5C548.997 508.5 505.537 396.95 478.998 383C439.998 362.5 398.998 368.5 373.998 362.5C309.864 347.108 345.206 213.005 294.998 170Z"
                        fill="url(#paint0_radial_222_3)"
                    >
                        <animate
                            attributeName="d"
                            dur="6s"
                ...
                "
                    ...
                    <radialGradient
                        id="paint0_radial_222_3"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(56.5 113.5) rotate(10.6834) scale(717.436 543.637)"
                    >
                        <stop
                            offset="0.232391"
                            stop-color="#E07A5F"
            ...
            <div className="absolute z-1 right-[0vw] bottom-[0vh] overflow-x-hidden">
                ...
                >
                    <path
                        d="M89.5 545.504C51.3011 566.305 0.5 617 0.5 617H700V0C700 0 657.935 169.583 641 181.5C614 200.5 554.457 201.208 518 225.5C467.225 259.333 511.58 415.303 451 420.5C396.119 425.208 412.811 403.022 358 408.5C308.606 413.437 308.769 530.65 261.355 545.504C213.154 560.605 133.933 521.309 89.5 545.504Z"
                ...
                "
                    ...
                    <radialGradient
                        id="paint0_radial_244_3"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(700.001 617) rotate(-168.204) scale(555.225 624.87)"
                    >
                        <stop
                            offset="0.392294"
                            stop-color="#81B29A"
            ...
            <div className="absolute top-0 left-0">
                ...
                >
                    <path
                        d="M134 224.5C84.1907 240.338 0 15 0 315V-100H700C700 -100 550.434 76.1692 471.5 92.5C389.799 109.403 334.579 41.7553 258.5 76C189.491 107.062 206.119 201.567 134 224.5Z"
                        fill="url(#paint0_radial_245_4)"
                    >
                        <animate
                            attributeName="d"
                            dur="3s"
                ...
                "
                    ...
                    <radialGradient
                        id="paint0_radial_245_4"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(28 -2.00001) rotate(4.72688) scale(582.481 206.212)"
                    >
                        <stop
                            offset="0.00986366"
                            stop-color="#E07A5F"
            ...
            <div
                className="absolute -left-[38.3vw] bottom-[0.2vh] overflow-hidden"
            ...
            >
                ...
                >
                    <path
                        d="M0 0V769H296C296 769 381.502 624.5 310 600C238.498 575.5 262.101 511.468 238.498 474C214.895 436.532 151.271 466 134 390.5C116.729 315 242.112 303.438 250 209.5C254.283 158.5 234.926 107.994 189.5 62C149.5 21.5 91.6806 0 61.6806 0H0Z"
                        fill="url(#paint0_radial_222_4)"
                    >
                        <animate
                            attributeName="d"
                            dur="5s"
                ...
                "
                    ...
                    <radialGradient
                        id="paint0_radial_222_4"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(38 42.5) rotate(43.7602) scale(784.365 1740.59)"
                    >
                        <stop
                            offset="0.0776659"
                            stop-color="#E07A5F"
            ...
            <div
                className="-bottom-[0vh] overflow-hidden"
                style={{ position: "absolute", zIndex: -100 }}
            >
                <svg
                    width="40.6vw"
                ...
                >
                    <path
                        d="M-0.000305176 197V82C-0.000305176 82 7.0224 -15.5145 73 3C134.699 27.8452 46.749 103.351 204.125 123.351C261.5 123.351 397.294 84.6501 462.5 91.9999C555.913 102.529 427.034 167 517.034 197H-0.000305176Z"
                        fill="url(#paint0_radial_245_5)"
                    >
                        <animate
                            attributeName="d"
                            dur="5s"
            ...
            "
                    ...
                    <radialGradient
                        id="paint0_radial_245_5"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(-3.73905e-05 183) rotate(-4.58835) scale(475.022 376.986)"
                    >
                        <stop
                            offset="0.15759"
                            stop-color="#E07A5F"
            ...
            <div className="justify-center pt-[19vh]">
                <h3
                    className="flex mx-auto justify-center py-3 px-5 text-[10vw] font-semibold text-transparent bg-clip-text gradient-animate"
                    style={{
                        background:

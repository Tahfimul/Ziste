                          ...
                          if(userContext!=null)
                            if(userContext.user!=null)
                                ...
                                <div className="flex flex-col gap-[1vh] px-[1vw] ">
                                    ...
                                    <button onClick={()=>{setShowPasswordModal(true)}} className="px-[1.3vw] py-[1vh] bg-[#9fa5db] border-2 border-transparent rounded-2xl shadow-lg text-[1.3vw] transition-transform duration-100 ease-in-out transform hover:bg-transparent hover:border-[#9fa5db]">Change Password</button>
                                    ...
                                    <button onClick={()=>{setShowDeleteAccountModal(true)}} className="px-[1.3vw] py-[1vh] bg-[#E07A5F] border-2 border-transparent rounded-2xl shadow-lg text-[1.3vw] transition-transform duration-100 ease-in-out transform hover:bg-transparent hover:border-[#E07A5F]">Delete Account</button>
                                </div>
                                                    ...
                                                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                                                        ...
                                                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                            ...
                                                            <div className="sm:flex sm:items-start">
                                                                ...
                                                                <h3 className="text-base font-semibold text-gray-900" id="modal-title">Delete account</h3>
                                                                
                                                                </div>
                                                            </div>
                                                            </div>
                                                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                            <button onClick={()=>{authContext.deleteAccount(); setShowDeleteAccountModal(false);}} type="button" className="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Submit</button>
                                                            <button onClick={()=>{setShowDeleteAccountModal(false)}} type="button" className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                                                        ...
                                                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                            ...
                                                            <div className="sm:flex sm:items-start">
                                                                ...
                                                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                <h3 className="text-base font-semibold text-gray-900" id="modal-title">Change password</h3>
                                                                <div className="mt-2">
                                                            ...
                                                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                            <button onClick={()=>{authContext.changePassword(password); setShowPasswordModal(false);}} type="button" className="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Submit</button>
                                                            <button onClick={()=>{setShowPasswordModal(false)}} type="button" className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
